...
class BatchedGenerator(object):
	...
	Args:
		input_p (shape=(batch_dim,num_features)): note num_features=9 must be true

	"""
	# scaling_x is a scikit MinMaxScaler object
        self.input_p = self.scaling_x.transform(input_p)
